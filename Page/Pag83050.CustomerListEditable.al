page 83050 "Customer List (Editable)"
{
    ApplicationArea = All;
    Caption = 'Customer List (Editable)';
    PageType = List;
    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                field("HK Customer"; Rec."HK Customer")
                {
                    ToolTip = 'Specifies the value of the HK Customer field.';
                }
                field("SG Customer"; Rec."SG Customer")
                {
                    ToolTip = 'Specifies the value of the SG Customer field.';
                }
