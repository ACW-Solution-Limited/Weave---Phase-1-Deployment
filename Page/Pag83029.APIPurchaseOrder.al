page 83029 APIPurchaseOrder
{
    APIGroup = 'app1';
    APIPublisher = 'weave';
    APIVersion = 'v2.0';
    ApplicationArea = All;
    Caption = 'apiPurchaseOrder';
    DelayedInsert = true;
    EntityName = 'PurchaseOrderCust';
    EntitySetName = 'PurchaseOrderCust';
    PageType = API;
    ...
    [ServiceEnabled]
    procedure SendCancelAppr(var actionContext: WebServiceActionContext)
    var
    ...
    begin
        ...
        If Rec."Request Approval" = true then begin
