page 83210 "API Posted Purchase Rcpt. Head"
{
    APIGroup = 'PowerBI';
    APIPublisher = 'ACW';
    APIVersion = 'v1.0';
    ApplicationArea = All;
    Caption = 'apiPostedPurchaseRcptHead';
    DelayedInsert = true;
    EntityName = 'postedpurchasereceiptheader';
    EntitySetName = 'postedpurchasereceiptheader';
    PageType = API;
