tableextension 83008 "Sales Invoice Header Ext" extends "Sales Invoice Header"
{
    fields
    {
        ...
        field(83009; "Commission Type"; Option) { Caption = 'Commission Type'; OptionMembers = " ",DirectBooking,B2COutreach,B2BOutreach,B2CCompanyAssign,B2BRenewal,B2CRenewal,"B2CCompanyAssign-PropertyViewing(OperationTeam)"; }
