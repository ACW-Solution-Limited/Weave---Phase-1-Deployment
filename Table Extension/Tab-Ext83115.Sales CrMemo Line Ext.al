tableextension 83115 "Sales Cr.Memo Line Ext" extends "Sales Cr.Memo Line"
{
    fields
    {
        ...
        field(83023; "Sales Credit Memo Guid for CRM"; Guid)
        {
            FieldClass = FlowField;
            CalcFormula = lookup("CDS acwapp_postedsalescreditmemo".acwapp_postedsalescreditmemoId where(acwapp_name = field("Document No.")));
        }
