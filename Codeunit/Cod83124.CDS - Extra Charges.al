codeunit 83124 "CDS Extra Charges"
{
    ...
    begin
        ...
        InsertIntegrationFieldMapping('CRM to BC Ext. Char.', ExtraCharges.FieldNo("Stripe/QFPay Invoice ID"), CRMExtraCharges.FieldNo(acwapp_StripeInvoiceID), IntegrationFieldMapping.Direction::ToIntegrationTable, '', true, false);
