report 83022 LeaseContractSalesCreditMemoHK
{
    RDLCLayout = './Layout/Rep83022.LeaseContractSalesCreditMemoHK.rdlc';
    ...
    dataset
    {
        dataitem(Header; "Sales Cr.Memo Header")
        {
            ...
            dataitem(Line; "Sales Cr.Memo Line")
            {
                ...
                //     AutoFormatType = 1;
                // }
                column(LineAmount_Line; g_lineAmount)
                {
                    // AutoFormatExpression = GetCurrencyCode();
                    // AutoFormatType = 1;
                }
    ...
    var
        ...
        CurrCode: Text[10];
        CurrSymbol: Text[10];
        ReportLbl: Label 'Credit Note';
        Sequence: Integer;
        g_BankAcctPostingGroup: Code[20];
        g_BankAcctPostingName: Text[100];

        g_BankAcctPostingAccountNo: Text[30];
        g_BankAcctPostingAddress: Text[100];
        g_BankAcctPostingAddress2: Text[50];
        g_BankAcctPostingCity: Text[30];
        g_BankAcctPostinCountry: Text[10];
