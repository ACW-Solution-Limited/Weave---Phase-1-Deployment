table 83107 "CDS acwapp_roomtypemaster"
{
  ExternalName = 'acwapp_roomtypemaster';
  TableType = CDS;
  Description = '';

  fields
  {
    field(1;acwapp_roomtypemasterId;GUID)
    {
      ExternalName = 'acwapp_roomtypemasterid';
      ExternalType = 'Uniqueidentifier';
      ExternalAccess = Insert;
      Description = 'Unique identifier for entity instances';
      Caption = 'Room Type Master';
    }
    ...
    field(25;statecode;Option)
    {
      ...
      Description = 'Status of the Room Type Master';
      Caption = 'Status';
      InitValue = " ";
    ...
    field(27;statuscode;Option)
    {
      ...
      ExternalType = 'Status';
      Description = 'Reason for the status of the Room Type Master';
  ...
  keys
  {
    key(PK;acwapp_roomtypemasterId)
    {
      Clustered = true;
    }
