table 83142 "CDS acwapp_productinventory"
{
    ExternalName = 'acwapp_productinventory';
    TableType = CDS;
    Description = '';

    fields
    {
        field(1; acwapp_productinventoryId; GUID)
        {
            ExternalName = 'acwapp_productinventoryid';
        ...
        field(37; acwapp_PropertyUnitID; Text[100])
        {
            ExternalName = 'acwapp_propertyunitid';
            ExternalType = 'String';
            Description = '';
            Caption = 'Property Unit ID';
        }
        field(38; acwapp_Company; GUID)
        {
        ...
        field(39; acwapp_CompanyName; Text[100])
        {
            FieldClass = FlowField;
        ...
        field(41; acwapp_ProductName; Text[100])
        {
            FieldClass = FlowField;
        ...
        field(42; acwapp_Inventory; Integer)
        {
            ExternalName = 'acwapp_inventory';
            ExternalType = 'Integer';
            Description = '';
            Caption = 'Inventory';
        }
        field(43; acwapp_ProductID; Text[100])
        {
    ...
    keys
    {
        key(PK; acwapp_productinventoryId)
        {
            Clustered = true;
        }
