table 83132 "CDS acwapp_expensetype"
{
    ...
    fields
    {
        field(1; acwapp_expensetypeId; GUID)
        {
            ExternalName = 'acwapp_expensetypeid';
        ...
        field(18; statecode; Option)
        {
            ...
            Description = 'Status of the Expense Type';
            Caption = 'Status';
            InitValue = " ";
        ...
        field(20; statuscode; Option)
        {
            ...
            ExternalType = 'Status';
            Description = 'Reason for the status of the Expense Type';
