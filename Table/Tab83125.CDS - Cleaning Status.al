table 83125 "CDS acwapp_cleaningstatus"
{
    ...
    fields
    {
        field(1; acwapp_cleaningstatusId; GUID)
        {
            ExternalName = 'acwapp_cleaningstatusid';
        ...
        field(25; statecode; Option)
        {
            ...
            Description = 'Status of the Cleaning Status';
            Caption = 'Status';
            InitValue = " ";
        ...
        field(27; statuscode; Option)
        {
            ...
            ExternalType = 'Status';
            Description = 'Reason for the status of the Cleaning Status';
    ...
    keys
    {
        key(PK; acwapp_cleaningstatusId)
        {
            Clustered = true;
        }
