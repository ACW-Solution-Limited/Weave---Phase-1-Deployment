table 82008 "Stripe Refund"
{
    ...
    fields
    {
        ...
        field(9; "Payment Intent"; Text[250])
        {
        }
        field(10; "Customer No."; Code[50]) { }
        field(19; "Sales Document Type"; Enum "Sales Document Type")
        {
            Caption = 'Sales Document Type';
            DataClassification = SystemMetadata;
        }

        field(20; "Sales Document No."; Code[100]) { DataClassification = ToBeClassified; }
